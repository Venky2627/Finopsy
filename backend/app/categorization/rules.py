...
MERCHANT_RULES = {
    ...
    Category.EDUCATION: ["coursera", "udemy", "byjus", "unacademy", "school", "college", "tuition", "fee"],
    ...
    Category.INCOME: ["salary", "payroll", "dividend", "interest"],
    Category.FEES: ["bank fee", "annual fee", "processing fee", "gst", "cgst", "sgst", "charge"]
}
